...
import com.drm.mimicapp_v20.ListCategoryActivity;
...
public class CategoriesEdit extends AsyncTask<String, String, String> {
    private static Context context;

    public CategoriesEdit(Context context) {
        CategoriesEdit.context = context;
    }
