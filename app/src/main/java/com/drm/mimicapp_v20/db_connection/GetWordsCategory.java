...
public class GetWordsCategory extends AsyncTask<String, String, String> {
    private static Context context;

    public GetWordsCategory(Context context) {
        GetWordsCategory.context = context;
    }
    ...
    protected void onPostExecute(String result) {
        ...
        intent.putExtra("categoryWords", result);
